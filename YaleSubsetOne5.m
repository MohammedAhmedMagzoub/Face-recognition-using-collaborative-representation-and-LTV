function [ErrorRate Recongition processingTime imgS] = YaleSubsetOne5(TrainDatabasePath)
tic
addpath 'C:\Users\Lenovo\Desktop\MMU\Epsilon Year\FYP\DataBase\Extended Yale Database\subset5'
addpath('LTV');
...
ErrorRate= 100-(t/200)*100
Recongition = (t/200)*100
processingTime = toc
toc
end