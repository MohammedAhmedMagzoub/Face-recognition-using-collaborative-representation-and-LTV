function [ErrorRate Recongition processingTime imgS] = YaleSubsetOne4(TrainDatabasePath)
tic
...
ErrorRate= 100-(t/260)*100
Recongition = (t/260)*100
processingTime = toc
end